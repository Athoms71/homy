...
export const CATEGORIES: {
  ...
  { value: 'canned',            label: 'Conserves & Épicerie', emoji: '🥫', color: 'bg-amber-100 text-amber-700' },
  { value: 'condiments',        label: 'Condiments & Sauces', emoji: '🧂', color: 'bg-lime-100 text-lime-700' },
  { value: 'cereals',           label: 'Céréales & Féculents', emoji: '🌾', color: 'bg-yellow-50 text-yellow-600' },
  ...
  { value: 'pharmacy',          label: 'Pharmacie', emoji: '💊', color: 'bg-red-50 text-red-600' },
