...
import { Plus, Loader2, LayoutList, Scale, ArrowLeft, Trash2 } from "lucide-react";
		...
		<div>
			...
			{showAdd && (
				<div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50 px-4">
					<div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-md p-6 shadow-xl max-h-[90vh] overflow-y-auto pb-8 sm:pb-6">
