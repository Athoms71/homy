...
import { BILL_CATEGORIES } from '@/lib/billConfig'
import { Loader2, Plus } from 'lucide-react'
import { cn } from '@/lib/utils'
import type { BillCategory, BillFrequency } from '@homy/shared-types'

const BILL_FREQUENCIES_SIMPLE = [
  { value: 'monthly' as BillFrequency, label: 'Mensuel', shortLabel: '/mois' },
  { value: 'annual' as BillFrequency, label: 'Annuel', shortLabel: '/an' },
]
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="EDF, Orange, Netflix, Assurance..." autoFocus required
      ...
      {/* Renouvellement auto */}
      <button
        type="button" onClick={() => setAutoRenew(v => !v)}
        className={cn(
      ...
      <button
        type="submit" disabled={isPending || !provider.trim() || !amount}
