    ...
    <>
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="bg-primary-600 px-5 py-4 flex items-center justify-between">
          ...
          <button onClick={() => setConfirmLeave(true)} disabled={leave.isPending}
            className="text-primary-200 hover:text-white transition p-1" title="Quitter le foyer"
          >
            <LogOut size={18} />
          </button>
        </div>
        ...
        <div className="px-5 py-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2">
            ...
            {isAdmin && (
              <button onClick={() => setConfirmRegen(true)} disabled={regenerate.isPending}
                className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition" title="Nouveau code"
              >
      ...
      {confirmLeave && (
        <ConfirmDialog
          ...
          onConfirm={() => { leave.mutate(household.id); setConfirmLeave(false) }}
      ...
      {confirmRegen && (
        <ConfirmDialog
          ...
          onConfirm={() => { regenerate.mutate(household.id); setConfirmRegen(false) }}
