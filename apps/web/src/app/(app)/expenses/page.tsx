...
export default function ExpensesPage() {
  ...
  if (activeGroup && currentUserId) return (
    <ExpenseGroupView group={activeGroup} members={members} currentUserId={currentUserId} onBack={() => setActiveGroup(null)} />
  )
    ...
    <div>
          ...
          <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-md p-6 shadow-xl pb-8 sm:pb-6">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <input type="text" value={newGroupName} onChange={e => setNewGroupName(e.target.value)}
                placeholder="Vacances, Coloc, Mariage..." autoFocus required
      ...
      {confirmDeleteId && (
        <ConfirmDialog
          ...
          onConfirm={() => { deleteGroup.mutate(confirmDeleteId); setConfirmDeleteId(null) }}
